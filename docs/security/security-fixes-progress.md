...
*Theo kế hoạch: docs/archive/pre-refactor/pre-refactor-2026-05-24.md v3, Phần "Phase 1"*
...
*Theo kế hoạch: docs/archive/pre-refactor/pre-refactor-2026-05-24.md v3, Phần "Phase 2"*
...
- [x] **Fix 7.3** (NĐ13 Điều 23): `docs/security/data-breach-response.md` — quy trình 4 giai đoạn (0–1h containment, 1–24h assessment, 24–72h report to A05, post-72h remediation).
- [x] **Fix 7.4** (NĐ13 Điều 24): `docs/security/dpia.md` — DPIA đầy đủ: data inventory, risk matrix, controls mapping, kết luận chấp nhận rủi ro trung bình.
