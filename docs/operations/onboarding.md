...
**Plan reference:** `docs/archive/pre-refactor/pre-refactor-2026-05-20.md` §11  
...
docs/refactor/phase-5/phase-5-preflight-probe.md   ← Phase 5 blocker inventory
docs/refactor/phase-5/phase-5-step-1-characterization.md  ← Route inventory + read-only candidates
docs/refactor/foundations/backup-restore-drill.md  ← Drill log (persons=1188 confirmed)
```
