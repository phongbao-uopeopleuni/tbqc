...
- `README.md` â€” HÆ°á»›ng dáº«n developer, cáº¥u hÃ¬nh, deploy.
- `CLAUDE.md` â€” Quy Æ°á»›c phÃ¡t triá»ƒn.
- `GENEALOGY_QA_CHECKLIST.md` â€” Checklist kiá»ƒm thá»­ há»“i quy.
- `GENEALOGY_ROLLOUT.md` â€” Káº¿ hoáº¡ch triá»ƒn khai theo giai Ä‘oáº¡n.
...
2. Cáº­p nháº­t file `SRS.md` + báº£ng truy váº¿t.
