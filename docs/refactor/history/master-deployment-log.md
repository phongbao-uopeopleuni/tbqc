...
**Plan gốc:** `docs/archive/pre-refactor/pre-refactor-2026-05-20.md` — §7 là danh sách domain Phase 1.
...
- Cập nhật `docs/refactor/foundations/legacy-inventory.md` ghi nhận vị trí mới.
...
M  docs/refactor/foundations/bootstrap-truth.md
M  docs/refactor/history/changelog-refactor.md
...
?? docs/refactor/history/master-deployment-log.md   (file này)
?? logs/.gitkeep
```
