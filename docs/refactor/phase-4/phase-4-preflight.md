...
**Plan reference:** `docs/archive/pre-refactor/pre-refactor-2026-05-20.md` section 10  
...
Recorded in `docs/refactor/phase-3/phase-3-closeout-audit.md`:
...
2. Check `docs/refactor/foundations/js-load-graph.md` for `window.*` dependency.
