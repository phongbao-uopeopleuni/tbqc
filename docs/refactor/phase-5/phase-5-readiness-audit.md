...
| Public activities gallery split | Deferred correctly | `docs/refactor/phase-4/phase-4-3-public-activities-preflight.md` |
| Members split | Deferred correctly | Phase 5 fence in `docs/refactor/phase-5/phase-5-step-1-characterization.md` |
| Phase 5 preflight | Complete | `docs/refactor/phase-5/phase-5-preflight-probe.md` |
| Phase 5 Step 1 characterization | Complete | `docs/refactor/phase-5/phase-5-step-1-characterization.md` |
| Production backup parity drill | PASS | `docs/refactor/foundations/backup-restore-drill.md`: `tbqc_backup_20260522_064546.sql`, `persons_count=1188`, 20 tables |
| Phase 5.1 implementation | Not started | Next step is read-only contract tests |

## Plan alignment

This state matches `docs/archive/pre-refactor/pre-refactor-2026-05-20.md`:
...
- `docs/refactor/history/changelog-refactor.md`
- `docs/refactor/phase-5/phase-5-preflight-probe.md`
- `docs/refactor/phase-5/phase-5-step-1-characterization.md`
