...
| Local restore drill | `docs/refactor/foundations/backup-restore-drill.md` records 2026-05-21 local synthetic restore pass, `persons_count = 1188` | PASS local |
...
2. Rerun production backup parity restore drill before each P0 mutation PR and update `docs/refactor/foundations/backup-restore-drill.md`.
