...
**Plan reference:** `docs/Pre-refactor May 20, 2026.md` sections 9, 12, 16.6, 16.7, 17.3  
...
- Remaining fallback/import entries are pre-existing and already tracked by `docs/refactor/IMPORT_PATH_AUDIT.md`.
