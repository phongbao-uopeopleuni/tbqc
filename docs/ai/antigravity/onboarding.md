...
```
docs/security/security-fixes-progress.md   ← Tổng quan 7 phases, phase nào DONE / PENDING
    ↓
...
**Phase đang cần làm tiếp:** Phase 5 — spec tại `docs/ai/antigravity/prompts/phase-5-prompt.md`.
...
| File | Nội dung |
|---|---|
| `docs/security/security-fixes-progress.md` | **Tracker chính** — trạng thái từng fix + audit receipts |
| `docs/archive/pre-refactor/pre-refactor-2026-05-24.md` | Kế hoạch gốc v3 — 26 findings, mô tả từng finding |
| `docs/ai/antigravity/prompts/review-prompt.md` | Bản đánh giá bảo mật ban đầu (26 findings với mã H/M/C/L) |
| `docs/ai/antigravity/onboarding.md` | File này |

### Spec theo phase (đọc khi làm phase đó)

| File | Phase |
|---|---|
| `docs/ai/antigravity/prompts/phase-3-prompt.md` | Phase 3 — IDOR & Access Control (DONE) |
| `docs/ai/antigravity/prompts/phase-4-prompt.md` | Phase 4 — Auth & Data Integrity (DONE) |
| `docs/ai/antigravity/prompts/phase-5-prompt.md` | **Phase 5 — Detection & Monitoring (VIỆC TIẾP THEO)** |

### Work logs (đọc để biết đã làm gì)

| File | Nội dung |
|---|---|
| `docs/ai/antigravity/logs/work-log-phase-1-2.md` | Phase 1 & 2 |
| `docs/ai/antigravity/logs/work-log-phase-3.md` | Phase 3 |
| `docs/ai/antigravity/logs/work-log-phase-4.md` | Phase 4 |
| `docs/ai/antigravity/logs/work-log-phase-5.md` | Phase 5 (tạo khi bắt đầu) |
