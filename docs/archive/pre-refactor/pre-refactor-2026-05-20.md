...
- Sau moi phase, cap nhat `docs/refactor/history/changelog-refactor.md` neu file nay da duoc tao.
...
6. Ghi `docs/refactor/foundations/backup-restore-drill.md` voi ngay drill, ten backup, ket qua.
```
