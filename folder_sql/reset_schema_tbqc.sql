...
CREATE TABLE IF NOT EXISTS persons (
    ...
    father_mother_id VARCHAR(50) COMMENT 'ID nhóm cha mẹ từ CSV (fm_272, fm_273, ...) — legacy fallback',
    family_unit_id   VARCHAR(50) NULL COMMENT 'FK → family_units.unit_id (Phase 7, nullable)',
    ...
    INDEX idx_family_unit_id (family_unit_id)
...
-- =====================================================
-- BẢNG 4: FAMILY_UNITS (Đơn vị gia đình — Phase 7, additive)
-- Mỗi row = 1 cặp cha+mẹ được quản lý tường minh.
-- father_mother_id trên persons vẫn giữ nguyên làm fallback.
-- =====================================================
...
-- FK từ persons.family_unit_id → family_units.unit_id (thêm sau khi cả 2 bảng đã tồn tại)
ALTER TABLE persons
    ADD CONSTRAINT fk_persons_family_unit
    FOREIGN KEY (family_unit_id) REFERENCES family_units(unit_id)
