...
CREATE TABLE persons (
    ...
    csv_id VARCHAR(50) UNIQUE COMMENT 'ID từ TBQC_FINAL.csv (P1, P2, ...)',
    fm_id VARCHAR(50) COMMENT 'ID nhóm cha mẹ từ CSV (Father_Mother_ID) - giúp xác định chính xác cha mẹ khi có nhiều người trùng tên',
    ...
    father_id INT COMMENT 'ID của cha (từ relationships.father_id)',
    mother_id INT COMMENT 'ID của mẹ (từ relationships.mother_id)',
    father_name VARCHAR(255) COMMENT 'Tên cha (để backup khi không có father_id hoặc cho tìm kiếm)',
    mother_name VARCHAR(255) COMMENT 'Tên mẹ (để backup khi không có mother_id hoặc cho tìm kiếm)',
    ...
    INDEX idx_name_generation (full_name, generation_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE death_records (
    ...
    grave_location VARCHAR(500), -- Mộ phần
    notes TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE relationships (
    ...
    fm_id VARCHAR(50) COMMENT 'FM_ID của nhóm cha mẹ (từ child) - giúp validate quan hệ chính xác',
    check_father_name VARCHAR(10) COMMENT 'Check tên bố từ CSV (ok/OK)',
    check_mother_name VARCHAR(10) COMMENT 'Check tên mẹ từ CSV (ok/OK)',
    notes TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ...
    INDEX idx_relationship_fm_id (fm_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
